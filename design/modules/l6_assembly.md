...
- **A.1 — Assembly 模块不存在（phase154 落地）**
...
- **A.2 — Instances 接口不存在（phase154 落地）**
...
- **A.3 — TaskSystem setter 注入（phase157 落地）**
...
- **A.4 — Runtime.initialize() 混合装配与业务（phase156/157 落地）**
...
- **A.5 — 各模块 createX 工厂缺失（phase155 落地）**

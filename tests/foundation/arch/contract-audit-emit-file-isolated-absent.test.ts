...
describe('Contract emitContractFileIsolated dead surface', () => {
  it('has no emitContractFileIsolated anywhere in the audit-emit source', () => {
    expect(auditEmitSource).not.toMatch(/\bemitContractFileIsolated\b/);
  });

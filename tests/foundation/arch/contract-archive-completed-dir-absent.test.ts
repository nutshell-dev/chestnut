...
describe('Contract CONTRACT_ARCHIVE_COMPLETED_DIR dead surface', () => {
  it('has no CONTRACT_ARCHIVE_COMPLETED_DIR anywhere in the dirs source', () => {
    expect(dirsSource).not.toMatch(/\bCONTRACT_ARCHIVE_COMPLETED_DIR\b/);
  });

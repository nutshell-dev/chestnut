...
const fixturePath = path.join(repoRoot, 'tests/foundation/arch/fixtures/process-spawn-conflict-reason-surface.ts');

describe('ProcessSpawnConflictReason surface', () => {

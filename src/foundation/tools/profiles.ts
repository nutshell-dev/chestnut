...
export const TOOL_PROFILES: Record<ToolProfile, ToolName[]> = {
  full:     [READ_TOOL_NAME, WRITE_TOOL_NAME, SEARCH_TOOL_NAME, LS_TOOL_NAME, SEND_TOOL_NAME, SUBMIT_SUBTASK_TOOL_NAME, DONE_TOOL_NAME, SPAWN_TOOL_NAME, DISPATCH_TOOL_NAME, SHADOW_TOOL_NAME, SKILL_TOOL_NAME, EXEC_TOOL_NAME, STATUS_TOOL_NAME, MEMORY_SEARCH_TOOL_NAME],

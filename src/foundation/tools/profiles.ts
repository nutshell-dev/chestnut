...
export const TOOL_PROFILES: Record<ToolProfile, ToolName[]> = {
  ...
  subagent: [READ_TOOL_NAME, WRITE_TOOL_NAME, SEARCH_TOOL_NAME, LS_TOOL_NAME, EXEC_TOOL_NAME, SKILL_TOOL_NAME, MEMORY_SEARCH_TOOL_NAME, ASK_CALLER_TOOL_NAME, EDIT_TOOL_NAME, MULTI_EDIT_TOOL_NAME],
  ...
  verifier: [READ_TOOL_NAME, LS_TOOL_NAME, SEARCH_TOOL_NAME],
};

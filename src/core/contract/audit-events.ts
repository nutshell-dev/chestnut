...
export const CONTRACT_AUDIT_EVENTS = {
  ...
  // Phase 1197: contract creation publish protocol
  CONTRACT_CREATION_CLAIMED: 'contract_creation_claimed',
...
export const CONTRACT_FILE_ROUTING: Readonly<Record<string, 'audit'>> = {
  ...
  contract_subtask_reset_to_todo: 'audit',
  ...
  contract_creation_claimed: 'audit',

...
import { INBOX_PENDING_DIR, DEAD_LETTER_DIR } from '../../foundation/messaging/index.js';
...
export function routeNotifyClaw(
  ...
  const dlqDir = isMotion ? undefined : path.join(chestnutRoot, motionClawId, 'inbox', DEAD_LETTER_DIR);

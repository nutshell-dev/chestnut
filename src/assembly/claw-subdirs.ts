...
export const CLAW_SUBDIRS = [
  ...
  //   - logs/chat-crash.log  ← L6 cli/chat-viewport (viewport/chat-viewport.ts CHAT_CRASH_LOG_FILE、phase 125 立)
  //   （watchdog log 已于 phase 1455 Step B 迁出至 watchdog/watchdog.log）
